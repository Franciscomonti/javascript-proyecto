...
function agregarCarrito(id) {
    ...
    carrito.push(new ProductoCarrito(productoSelecFav))
...
function agregarFavorito(id) {
    ...
    almacenarProductosLocalStorage(favoritos)
    contadorFavoritos()
}
...
function almacenarProductosLocalStorage(lista) {
    localStorage.setItem("localFavoritos", JSON.stringify(lista));
    }
